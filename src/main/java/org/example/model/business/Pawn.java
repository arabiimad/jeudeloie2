...
public class Pawn {
    ...
    private int remainingPrisonTurns;
    ...
    /**
     * Launch  decrement the Prison Turns
     *
     */
    public void decrementPrisonTurns() {
        if (remainingPrisonTurns > 0) {
            remainingPrisonTurns--;
        }
        if (remainingPrisonTurns == 0) {
            inPrison = false;
        }
    ...
    public int getRemainingPrisonTurns() {
    return remainingPrisonTurns;
    }

    public void setRemainingPrisonTurns(int remainingPrisonTurns) {
    this.remainingPrisonTurns = remainingPrisonTurns;
    }
}